...
import mon.str.pokemon.PokemonTypeManipulator;
import mon.str.pokemon.PokemonTypes;
...
public class PokemonTypeLoader {
	...
	private ArrayList<PokemonTypes> weakness = new ArrayList<>();
	private ArrayList<PokemonTypes> resistant = new ArrayList<>();
	private ArrayList<PokemonTypes> immunity = new ArrayList<>();
	private ArrayList<PokemonTypeManipulator> typesets = new ArrayList<PokemonTypeManipulator>();
